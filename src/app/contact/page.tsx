...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Use relative path for API; Nginx will proxy /api to backend
      ...
      <main className={styles.contactContent}>
        ...
        <div className={styles.contactContainer}>
          <div className={styles.contactInfo}>
            ...
            <p>Our team is available to answer your questions. Reach out through any of the channels below.</p>
            <ul className={styles.infoList}>
              <li>
                <FaPhoneAlt /> <a href="tel:+917222029111">+91-7222029111</a>
              </li>
              <li>
                <FaEnvelope /> <a href="mailto:info@amsaoverseas.com">info@amsaoverseas.com</a>
              </li>
              <li>
                <FaMapMarkerAlt /> <span>Gera's Imperium Rise, Hinjewadi phase 2, Maharashtra 411057</span>
              </li>
            </ul>
            <div className={styles.socialIcons}>
              <a
                href="https://www.instagram.com/amsa_overseas"
                target="_blank"
                rel="noreferrer"
